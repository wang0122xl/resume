...
const ProjectExperience = () => {
    return (
        ...
        <p><span>项目成绩：</span></p>
        <section>
            <p>独立完成产品iOS基座的开发、维护工作</p>
            <p>解决产品长期存在的自动登录白屏问题，提升用户体验，有效避免因登录白屏引发的客诉</p>
            <p>设计实现h5页面预缓存方案，使页面跳转中的loading持续时间缩短60%以上</p>
        ...
        <section>
            ...
            <p>通过jenkins配置，实现项目的云端集成，提高升级效率</p>
        </section>
        ...
        <section>
            ...
            <p>基于cornerstone实现的dicom文件在线阅片、标注、保存功能，根据需求定制标注工具</p>
        ...
        <section>
            ...
            <p>设计并实现rn bundle的版本控制方案，实现对应的可视化版本管理工具，并负责方案中 iOS和web 端的代码编写</p>
            <p>设计并实现rn bundle的拆包、预加载及增量热更方案。配合 gitlab-ci 实现代码的半自动发布和自动化版本控制</p>
