 ...
 * @LastEditTime: 2021-09-01 23:51:50
...
const ProjectExperience = () => {
    return (
        ...
        <p><span>个人成绩：</span></p>
        <section>
            <p>采用yarn workspance + lerna方案管理代码，既保证了基础组件，底层工具及发布流程的高复用性，又确保了两个项目业务逻辑互相分离</p>
            <p>与硬件工程师现场调试，基于http / socket方式与工作站通信，下发实验请求，上报实验结果</p>
            <p>独立负责LIMS核心模块-数据录入公式自动计算结果(mathjs)，及LIS所有模块开发</p>
            <p>为满足LIS / LIMS的报告打印和下载需求，独立开发了基于 dom-to-image 和 jsPdf 的 html 页面打印方案并开源至公司组件库</p>
        </section>

        <h3>实验室图像采集H5(React + Koa)</h3>
        <p className="mb-10px">
            <span>项目描述</span>
            实验室图像采集H5是为公司数据部门研发的一款收集实验室显微镜结果的H5小工具。
        </p>
        <p><span>个人成绩：</span></p>
        <section>
            <p>深度参与需求分析，为客户(数据部门)提供实现方案</p>
            <p>独立负责项目的设计、交互、前端、后端及代码部署工作</p>
        ...
        <p><span>个人成绩：</span></p>
        <section>
            <p>项目整体使用 Taro-React ，其中饮食打卡模块采用Vue H5内嵌以加快开发进度</p>
        ...
        <section>
            ...
            <p>独立完成项目 weex 代码的版本控制方案，并实现对应的可视化发布工具，使发布代码不再完全依赖开发和运维</p>
