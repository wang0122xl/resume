 ...
 * @LastEditTime: 2021-09-02 18:05:49
...
const Skill = () => {
    return (
        ...
        <section>
            ...
            <p>熟练掌握 React、Vue 等常用前端框架, 结合Context/Redux、Vuex快速构建项目</p>
            <p>熟练使用前端开发构建工具 Webpack/Vite, 并了解其常用优化方案 </p>
            <p>熟练掌握 Objective-C, 擅长 H5, react-native 等混合App 方案，可独立开发上线功能完善的混合App。了解Flutter</p>
